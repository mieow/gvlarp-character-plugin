...
if (!empty($_GET['color'])) include_once('overlays/'.$_GET['color'].'.php');

# include css reset stuff
...
.ui-widget-overlay {
	...
	top: 0;
	width: 100%;
	background: <?php echo($Imagesp_ImageOverlay); ?>;
	opacity: .50;
...
#spMainContainer #spQuickLinksForum .dd .ddChild a:hover {
	background: <?php echo($alt2SectionHover); ?>;

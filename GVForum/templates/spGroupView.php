						...
						if (sp_has_forums()) : while (sp_loop_forums()) : sp_the_forum();
							...
							sp_SectionStart('tagClass=spGroupForumSection', 'forum');
								...
								sp_ColumnStart('tagClass=spColumnSection spRight&width=14%&height=55px');
									...
									sp_ForumIndexStatusIcons('tagClass=spStatusIcon spCenter', __sp('This forum is locked'), __sp('This forum has unread posts in %COUNT% topic(s)'), __sp('Add new topic in this forum'));
								sp_ColumnEnd();

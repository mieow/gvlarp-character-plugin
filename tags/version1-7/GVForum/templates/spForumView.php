		...
		sp_SectionStart('tagClass=spListSection', 'forumView');
			...
			if (sp_this_forum()):
				...
				sp_SectionStart('tagId=spTopicNewButtonTop&tagClass=spPlainSection', 'pageLinks');
					sp_TopicNewButton('tagClass=spButton spRight', __sp('Add Topic'), __sp('Start a new topic'), __sp('This forum is locked'));
				...
				sp_SectionStart('tagClass=spPlainSection', 'pageLinks');
					sp_TopicNewButton('tagId=spTopicNewButtonBottom&tagClass=spButton spRight', __sp('Add Topic'), __sp('Start a new topic'), __sp('This forum is locked'));
					sp_TopicIndexPageLinks('', __sp('Page: '), __sp('Jump to page %PAGE% of topics'));
					sp_InsertBreak();
